...
<div class="container-fluid px-4">
    <h2 class="fw-bold mb-4">{{ __('settings.title') }}</h2>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-transparent border-0 pt-4">
                    <h5 class="fw-semibold mb-0">{{ __('settings.preferences') }}</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('settings.update') }}" id="settingsForm">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="d-flex gap-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="language" id="langEn" value="en" {{ $settings['language'] === 'en' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="langEn">
                                        <i class="fa-solid fa-language me-1"></i> English
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="language" id="langFr" value="fr" {{ $settings['language'] === 'fr' ? 'checked' : '' }}>
                        ...
                        <!-- Thème -->
                        <div class="mb-4">
                            <label class="form-label fw-semibold">{{ __('settings.theme') }}</label>
                            <div class="d-flex gap-4">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="theme" id="themeLight" value="light" {{ $settings['theme'] === 'light' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="themeLight">
                                        <i class="fa-regular fa-sun me-1"></i> {{ __('settings.light') }}
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="theme" id="themeDark" value="dark" {{ $settings['theme'] === 'dark' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="themeDark">
                                        <i class="fa-regular fa-moon me-1"></i> {{ __('settings.dark') }}
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Notifications -->
                        <div class="mb-4">
                            <label class="form-label fw-semibold">{{ __('settings.notifications') }}</label>
                            <div class="form-check form-switch mb-2">
                                ...
                                <label class="form-check-label" for="emailNotifications">{{ __('settings.email_notifications') }}</label>
                            </div>
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="push_notifications" id="pushNotifications" {{ $settings['push_notifications'] ?? true ? 'checked' : '' }}>
                                <label class="form-check-label" for="pushNotifications">{{ __('settings.push_notifications') }}</label>
                            </div>
                        </div>

                        <button type="submit" class="btn btn-primary">
                            <i class="fa-solid fa-save me-2"></i>{{ __('settings.save') }}
                        </button>
                    </form>
                </div>
            </div>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-transparent border-0 pt-4">
                    <h5 class="fw-semibold mb-0">{{ __('settings.information') }}</h5>
                </div>
                <div class="card-body">
                    <p><i class="fa-regular fa-circle-check text-success me-2"></i> {{ __('settings.auto_save') }}</p>
                    <p><i class="fa-regular fa-clock me-2"></i> {{ __('settings.last_update') }}: {{ now()->format('d/m/Y H:i') }}</p>
                </div>
            </div>
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const savedLang = localStorage.getItem('language') || '{{ $settings["language"] }}';
