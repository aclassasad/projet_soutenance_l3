...
<head>
    ...
    <title>@yield('title', 'SecureStore - Caissier')</title>
...
<body>
    ...
    <div class="sidebar-caissier" id="sidebarCaissier">
        ...
        <div class="nav-caissier">
            <a href="{{ route('caissier.dashboard') }}" class="nav-item-caissier {{ request()->routeIs('caissier.dashboard') ? 'active' : '' }}">
                <i class="fa-solid fa-cash-register"></i>
                <span>Point de Vente</span>
            </a>
            
            <a href="{{ route('caissier.historique') }}" class="nav-item-caissier {{ request()->routeIs('caissier.historique') ? 'active' : '' }}">
                <i class="fa-solid fa-clock-rotate-left"></i>
                <span>Historique</span>
            </a>
            
            <a href="{{ route('caissier.stock') }}" class="nav-item-caissier {{ request()->routeIs('caissier.stock') ? 'active' : '' }}">
                ...
                @endphp
                @if($stockAlert > 0)
                    <span class="badge">{{ $stockAlert }}</span>
                @endif
            </a>
            
            <!--<a href="{{ route('caissier.stats') }}" class="nav-item-caissier {{ request()->routeIs('caissier.stats') ? 'active' : '' }}">
        ...
        <div class="user-info">
            <div class="d-flex align-items-center mb-3">
                ...
                <div class="user-details">
                    <div class="name">{{ $user->name ?? 'Caissier' }}</div>
                    <div class="role">{{ $user->role ?? 'Caissier' }}</div>
                </div>
            </div>
