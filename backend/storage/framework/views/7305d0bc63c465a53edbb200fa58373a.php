            ...
            <div class="card border-0 shadow-sm h-100 hover-card">
                <div class="card-body d-flex flex-row flex-md-column flex-lg-row justify-content-between align-items-center p-3 p-md-4">
                    <div class="w-75 w-md-100 w-lg-75">
                        ...
                        <h4 class="fw-bold mb-1 fs-5 fs-md-4"><?php echo e(number_format($stats['total_revenu'] ?? 297000, 0)); ?> <small class="fs-6">FCFA</small></h4>
            ...
            <div class="card border-0 shadow-sm h-100 hover-card">
                <div class="card-body d-flex flex-row flex-md-column flex-lg-row justify-content-between align-items-center p-3 p-md-4">
                    <div class="w-75 w-md-100 w-lg-75">
                        ...
                        <h4 class="fw-bold mb-1 fs-5 fs-md-4"><?php echo e(number_format($stats['total_commandes'] ?? 2220, 0)); ?></h4>
                        <span class="text-success small">
            ...
            <div class="card border-0 shadow-sm h-100 hover-card">
                <div class="card-body d-flex flex-row flex-md-column flex-lg-row justify-content-between align-items-center p-3 p-md-4">
                    <div class="w-75 w-md-100 w-lg-75">
                        ...
                        <h4 class="fw-bold mb-1 fs-5 fs-md-4"><?php echo e(number_format($stats['moyenne_commande'] ?? 133.78, 2)); ?> <small class="fs-6">FCFA</small></h4>
                        <span class="text-success small">
            ...
            <div class="card border-0 shadow-sm h-100 hover-card">
                <div class="card-body d-flex flex-row flex-md-column flex-lg-row justify-content-between align-items-center p-3 p-md-4">
                    <div class="w-75 w-md-100 w-lg-75">
                        ...
                        <h4 class="fw-bold mb-1 fs-5 fs-md-4"><?php echo e(number_format($stats['clients_uniques'] ?? 1847, 0)); ?></h4>
                        <span class="text-success small">
                    ...
                    <div class="card-footer bg-transparent border-0 pb-3 pb-md-4 px-3 px-md-4">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <div class="d-flex align-items-center">
                                <span class="d-inline-block rounded-circle me-2" style="width: 10px; width-md: 12px; height: 10px; height-md: 12px; background-color: <?php echo e(['#4361EE', '#06B6D4', '#10B981', '#F59E0B'][$index % 4]); ?>"></span>
                                <span class="small"><?php echo e($cat->nom); ?></span>
                            </div>
                            <span class="fw-semibold small"><?php echo e(number_format(($cat->revenu / $categories->sum('revenu')) * 100, 1)); ?>%</span>
                        </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-around" style="height: 160px; height-md: 180px; width: 100%;">
                        <?php $__currentLoopData = $transactionsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="text-center" style="flex: 1; max-width: 40px; max-width-md: 50px;">
                                <div class="bg-primary rounded-3 mb-1 mx-auto" 
                                     style="width: 20px; width-md: 30px; height: <?php echo e($barHeight); ?>px; background-color: #4361EE;"></div>
                                <span class="small d-block text-truncate" style="max-width: 40px; max-width-md: 50px; font-size: 9px; font-size-md: 11px;">
                                    <?php echo e(['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'][$index]); ?>

                                </span>
                                <span class="small text-muted d-block" style="font-size: 8px; font-size-md: 10px;"><?php echo e($displayValue); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
        ...
        <div class="col-12 col-md-6">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    ?>
                    <div class="d-flex align-items-end justify-content-around" style="height: 160px; height-md: 180px; width: 100%;">
                        <?php $__currentLoopData = $hourlyData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="text-center" style="flex: 1; max-width: 40px; max-width-md: 50px;">
                                <div class="bg-info rounded-3 mb-1 mx-auto" 
                                     style="width: 20px; width-md: 30px; height: <?php echo e($barHeight); ?>px; background-color: #06B6D4;"></div>
                                <span class="small d-block text-truncate" style="max-width: 40px; max-width-md: 50px; font-size: 9px; font-size-md: 11px;">
                                    <?php echo e(['10AM', '12PM', '2PM', '4PM', '6PM', '8PM'][$index]); ?>

                                </span>
                                <span class="small text-muted d-block" style="font-size: 8px; font-size-md: 10px;"><?php echo e($value); ?></span>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $topProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="px-2 px-md-4 py-3 fw-semibold"><?php echo e($index + 1); ?></td>
                            <td class="px-2 px-md-4 py-3 small"><?php echo e($prod->nom); ?></td>
                            <td class="px-2 px-md-4 py-3 text-end small"><?php echo e($prod->lignes_vente_count ?? $prod->total_quantity ?? 0); ?> units</td>
                            <td class="px-2 px-md-4 py-3 fw-semibold text-end small"><?php echo e(number_format($prod->lignesVente->sum(fn($lv) => $lv->quantite * $lv->prix_unitaire) ?? $prod->total_revenue ?? 0, 0)); ?> FCFA</td>
                            <td class="px-2 px-md-4 py-3">
                                ...
                                <div class="d-flex align-items-center gap-2" style="min-width: 80px; min-width-md: 100px;">
                                    ...
                                    <span class="small text-muted" style="font-size: 10px; font-size-md: 12px;"><?php echo e(number_format($percentage, 0)); ?>%</span>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    new Chart(document.getElementById('revenueTrend'), {
        type: 'line',
        data: {
            labels: <?php echo json_encode($trend->pluck('mois')->toArray() ?? ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun']); ?>,
            datasets: [{
                label: 'Revenue',
                data: <?php echo json_encode($trend->pluck('revenu')->toArray() ?? [80000, 60000, 40000, 20000, 50000, 70000]); ?>,
                borderColor: '#4361EE',
    ...
    new Chart(document.getElementById('salesByCategory'), {
        type: 'doughnut',
        data: {
            labels: <?php echo json_encode($categories->pluck('nom')->toArray() ?? ['Electronics', 'Utilities', 'Grocery', 'Other']); ?>,
            datasets: [{
                data: <?php echo json_encode($categories->pluck('revenu')->toArray() ?? [33, 26, 14, 9]); ?>,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\modif\projet_soutenance_l3\backend\resources\views/sales.blade.php ENDPATH**/ ?>