            ...
            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #4361EE, #3A56D4);">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0 text-white"><?php echo e($stats['total'] ?? 0); ?></h3>
                    </div>
            ...
            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #10b981, #0f9d6e);">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0 text-white"><?php echo e($stats['actifs'] ?? 0); ?></h3>
                    </div>
                    <div class="bg-white bg-opacity-20 rounded-3 p-3">
            ...
            <div class="card border-0 shadow-sm h-100" style="background: linear-gradient(135deg, #184E77, #76C893);">
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="fw-bold mb-0 text-white"><?php echo e($stats['conges'] ?? 0); ?></h3>
                    </div>
                    <div class="bg-white bg-opacity-20 rounded-3 p-3">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="rounded-circle d-flex align-items-center justify-content-center me-3" 
                             style="width: 60px; height: 60px; background: <?php echo e(['#4361EE', '#10b981', '#f59e0b', '#ef4444'][$loop->index % 4]); ?>10;">
                            <span class="fw-bold fs-5" style="color: <?php echo e(['#4361EE', '#10b981', '#f59e0b', '#ef4444'][$loop->index % 4]); ?>;">
                                <?php echo e(strtoupper(substr($emp->name, 0, 2))); ?>

                            </span>
                        </div>
                        <div>
                            <h5 class="fw-bold mb-1"><?php echo e($emp->name); ?></h5>
                            <?php
                                $roleLabels = [
                            ...
                            ?>
                            <span class="badge bg-<?php echo e($roleColors[$emp->role] ?? 'secondary'); ?> bg-opacity-10 text-<?php echo e($roleColors[$emp->role] ?? 'secondary'); ?> px-3 py-1 rounded-pill fw-semibold">
                                <?php echo e($roleLabels[$emp->role] ?? strtoupper($emp->role)); ?>
                    ...
                    <div class="mb-3">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <span class="small"><?php echo e($emp->email); ?></span>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            <i class="fa-regular fa-phone text-muted me-2" style="width: 20px;"></i>
                            <span class="small"><?php echo e($emp->telephone ?? '(555) ' . rand(100, 999) . '-' . rand(1000, 9999)); ?></span>
                        </div>
                        <div class="d-flex align-items-center mb-2">
                            <i class="fa-regular fa-clock text-muted me-2" style="width: 20px;"></i>
                            <span class="small"><?php echo e($emp->horaire ?? ($emp->role === 'gerant' ? 'Afternoon (12PM-8PM)' : 'Morning (8AM-4PM)')); ?></span>
                        </div>
                        <div class="d-flex align-items-center">
                            <i class="fa-regular fa-calendar text-muted me-2" style="width: 20px;"></i>
                            <span class="small">Joined: <?php echo e($emp->created_at ? $emp->created_at->format('d/m/Y') : now()->subMonths(rand(1, 12))->format('d/m/Y')); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group">
                            <a href="<?php echo e(route('users.edit', $emp)); ?>" class="btn btn-sm btn-outline-primary border-0">
                                <i class="fa-regular fa-pen-to-square"></i>
                            </a>
                            <a href="<?php echo e(route('users.show', $emp)); ?>" class="btn btn-sm btn-outline-info border-0">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\modif\projet_soutenance_l3\backend\resources\views/employees.blade.php ENDPATH**/ ?>