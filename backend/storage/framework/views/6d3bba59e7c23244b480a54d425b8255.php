    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="fw-bold mb-1"><?php echo e($entreprise); ?></h5>
                    <p class="text-muted mb-0">
                        <i class="fa-regular fa-user me-1"></i> Caissier : <?php echo e($user->name ?? 'Non connecté'); ?>
                ...
                <div class="text-end">
                    ...
                    <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2 rounded-pill">
                        <i class="fa-regular fa-calendar me-1"></i> <?php echo e($date instanceof \Carbon\Carbon ? $date->format('d/m/Y') : now()->format('d/m/Y')); ?>

                    </span>
                    <span class="badge bg-info bg-opacity-10 text-info px-3 py-2 rounded-pill ms-2">
                        <i class="fa-regular fa-clock me-1"></i> <?php echo e($date instanceof \Carbon\Carbon ? $date->format('H:i') : now()->format('H:i')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.cashier', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\modif\projet_soutenance_l3\backend\resources\views/caissier/dashboard.blade.php ENDPATH**/ ?>